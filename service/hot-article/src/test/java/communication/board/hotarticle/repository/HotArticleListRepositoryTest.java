package communication.board.hotarticle.repository;
...
class HotArticleListRepositoryTest {
    ...
    void addTest() throws InterruptedException {
        // given
        LocalDateTime time = LocalDateTime.of(2024, 8, 6, 0, 0);
        long limit = 3;
        ...
        // then
        List<Long> articleIds = hotArticleListRepository.readAll("20240806");
        ...
        assertThat(hotArticleListRepository.readAll("20240806")).isEmpty();
    }
}