package communication.board.article.service;

import communication.board.article.entity.Article;
import communication.board.article.entity.BoardArticleCount;
import communication.board.article.repository.ArticleRepository;
import communication.board.article.repository.BoardArticleCountRepository;
...
public class ArticleService {
    ...
    public ArticleResponse update(Long articleId, ArticleUpdateRequest request) {
        Article article = articleRepository.findById(articleId).orElseThrow(); // 없는 게시판일 경우 예외 던지기
